 ...
 *  com.ocxworker.service.OciGenerativeOpenAiService
 *  com.ocxworker.service.OciProxyConfigService
 *  com.ocxworker.service.OracleAiGatewayConfigService
 *  com.ocxworker.service.OracleAiPortBindingService
...
public class OciGenerativeOpenAiService {
    ...
    public void proxy(OciUser tenant, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        block47: {
            ...
            String regionId = OciGenerativeOpenAiService.effectivePublicRegionId((OciUser)tenant, (Object)request.getAttribute("ocxworker.openai.ociRegion"));
            ...
            request.setAttribute("ocxworker.debug.origPathAfterV1", (Object)origPathAfterV1);
            ...
            if ("POST".equalsIgnoreCase(method) && OciGenerativeOpenAiService.isChatCompletionsPath((String)origPathAfterV1) && origBody != null && origBody.length > 0) {
                ...
                if (bodyMentionsMultiAgent) {
                    if (OciGenerativeOpenAiService.isStreamRequest((byte[])origBody, (String)contentType)) {
                        request.setAttribute("ocxworker.rewrite.simulateSse", (Object)Boolean.TRUE);
                    }
                    request.setAttribute("ocxworker.rewrite.chatToResponses", (Object)Boolean.TRUE);
                    request.setAttribute("ocxworker.rewrite.useRawV1Base", (Object)Boolean.TRUE);
                    request.setAttribute("ocxworker.rewrite.model", (Object)"multi-agent");
                    ...
                    try {
                        if (request != null && body != null) {
                            request.setAttribute("ocxworker.debug.responsesInputShape.before", (Object)OciGenerativeOpenAiService.describeResponsesInputShape((byte[])body));
                        }
                        ...
                        if (request != null && body != null) {
                            request.setAttribute("ocxworker.debug.responsesInputShape.after", (Object)OciGenerativeOpenAiService.describeResponsesInputShape((byte[])body));
                        }
                    }
                    catch (Exception raw) {}
                    ...
                    try {
                        ...
                        if (root != null && root.isObject()) {
                            ...
                            if (OciGenerativeOpenAiService.isLikelyMultiAgentModelName((String)model)) {
                                ...
                                request.setAttribute("ocxworker.rewrite.chatToResponses", (Object)Boolean.TRUE);
                                if (model != null) {
                                    request.setAttribute("ocxworker.rewrite.model", (Object)model);
                                }
                                request.setAttribute("ocxworker.rewrite.useRawV1Base", (Object)Boolean.TRUE);
                                pathAfterV1 = "/responses";
                                body = OciGenerativeOpenAiService.transformChatCompletionsToResponsesJson((byte[])origBody, (int)requestDefaultMaxTokens);
        ...
        if ("POST".equalsIgnoreCase(method) && OciGenerativeOpenAiService.isResponsesPath((String)origPathAfterV1) && body != null && body.length > 0 && looksLikeJson) {
            try {
                ...
                if (request != null) {
                    request.setAttribute("ocxworker.debug.responsesInputShape.after", (Object)OciGenerativeOpenAiService.describeResponsesInputShape((byte[])body));
                    if (OciGenerativeOpenAiService.isStreamRequest((byte[])origBody, (String)contentType)) {
                        request.setAttribute("ocxworker.rewrite.forceBuffer", (Object)Boolean.TRUE);
                    }
                }
            }
        ...
        if (!(useRawV1Base = Boolean.TRUE.equals(request.getAttribute("ocxworker.rewrite.useRawV1Base"))) && OciGenerativeOpenAiService.isResponsesPath((String)origPathAfterV1) && origBody != null && origBody.length > 0 && looksLikeJson) {
            try {
                root = MAPPER.readTree(origBody);
        ...
        request.setAttribute("ocxworker.debug.finalPathAfterV1", pathAfterV1);
    ...
    public JsonNode createGenerativeAiProject(OciUser tenant, String displayName) throws Exception {
        ...
        String name = displayName == null || displayName.isBlank() ? "ocxworker-default" : displayName.trim();
    ...
    private static ObjectNode ociItemToOpenAi(JsonNode oci) {
        ...
        if (OciGenerativeOpenAiService.isLikelyMultiAgentModelName((String)id) || display != null && display.isTextual() && OciGenerativeOpenAiService.isLikelyMultiAgentModelName((String)display.asText())) {
            row.put("ocxworkerNote", "\u8be5\u6a21\u578b\u4e3a Multi Agent\uff1a\u672c\u7f51\u5173\u4f1a\u628a /v1/chat/completions \u6539\u5199\u4e3a /v1/responses \u5e76\u5c3d\u91cf\u628a\u54cd\u5e94\u88c5\u6210 chat.completion\u3002 OCI \u901a\u5e38\u8981\u6c42 OpenAI-Project \u6216 opc-conversation-store-id\uff1b\u53ef\u5728\u300cOracle \u751f\u6210\u5f0f AI\u300d\u9875\u4e3a\u79df\u6237\u4fdd\u5b58\u9ed8\u8ba4\u503c\uff0c\u6216\u7531\u4e0a\u6e38\u8f6c\u53d1\u660e\u6587\u5934\u3002");
        }
        return row;
    }
    ...
    private static List<String> requestAllowedModels(HttpServletRequest request) {
        ...
        Object v = request.getAttribute("ocxworker.openai.allowedModelsJson");
        if (v == null) {
            return List.of();
        }
    ...
    private static int requestDefaultMaxTokens(HttpServletRequest request) {
        if (request != null) {
            Object v = request.getAttribute("ocxworker.openai.defaultMaxTokens");
            ...
            if (code >= 400) {
                ...
                try {
                    ...
                    if (request != null) {
                        ...
                        String origPath = String.valueOf(request.getAttribute("ocxworker.debug.origPathAfterV1"));
                        String finalPath = String.valueOf(request.getAttribute("ocxworker.debug.finalPathAfterV1"));
                        String before = String.valueOf(request.getAttribute("ocxworker.debug.responsesInputShape.before"));
                        String after = String.valueOf(request.getAttribute("ocxworker.debug.responsesInputShape.after"));
    ...
    private void bufferAndCopy(HttpClient client, HttpRequest httpRequest, HttpServletResponse response, HttpServletRequest request) throws IOException {
        try {
            ...
            if (code >= 400 && request != null && b != null) {
                ...
                boolean maybeResponses = Boolean.TRUE.equals(request.getAttribute("ocxworker.rewrite.useRawV1Base")) || OciGenerativeOpenAiService.isResponsesPath((String)String.valueOf(request.getAttribute("ocxworker.debug.finalPathAfterV1"))) || OciGenerativeOpenAiService.isResponsesPath((String)String.valueOf(request.getAttribute("ocxworker.debug.origPathAfterV1"))) || OciGenerativeOpenAiService.isResponsesPath((String)OciGenerativeOpenAiService.extractPathAfterV1((HttpServletRequest)request));
                String before = String.valueOf(request.getAttribute("ocxworker.debug.responsesInputShape.before"));
                String after = String.valueOf(request.getAttribute("ocxworker.debug.responsesInputShape.after"));
                String rid = OciGenerativeOpenAiService.firstRequestHeader((HttpServletRequest)request, (String[])new String[]{"x-request-id", "x-cursor-request-id", "x-openai-request-id", "x-amzn-trace-id", "traceparent"});
                String origPath = String.valueOf(request.getAttribute("ocxworker.debug.origPathAfterV1"));
            ...
            if (code >= 200 && code < 300 && request != null && Boolean.TRUE.equals(request.getAttribute("ocxworker.rewrite.chatToResponses")) && b != null && !b.isBlank() && (ct = resp.headers().firstValue("content-type").orElse("application/json; charset=utf-8")).toLowerCase().contains("json")) {
                try {
                    String text;
                    String modelHint = (String)request.getAttribute("ocxworker.rewrite.model");
                    if (Boolean.TRUE.equals(request.getAttribute("ocxworker.rewrite.simulateSse")) && (text = OciGenerativeOpenAiService.extractResponsesAssistantText((ObjectNode)((ObjectNode)MAPPER.readTree(b)))) != null) {
                        response.setStatus(200);
